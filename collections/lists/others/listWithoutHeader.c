...
//Funcion para imprimir todos los datos de la lista
void ImprimirLista(NODO *cabeza){
    NODO *nAux = cabeza;
...
//Funcion para verificar si una lista est� vac�a
int EstaVacia(NODO *cabeza){
    if ( cabeza == NULL)
        return 1;
    else
...
//Funcion para verificar si existe un elemento en la lista
int ExisteElemento(NODO *cabeza, int dato){
    NODO *nAux = cabeza;
