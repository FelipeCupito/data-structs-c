...
/* Agrega un elemento a la matriz. Si no lo pudo agregar o los parametros 
...
** La cantidad de elementos del vector serÃ¡ rows(m) 
** Si una fila no tiene elementos, el mÃ¡ximo de la misma serÃ¡ min.
 */
